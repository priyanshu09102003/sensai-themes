...
export default function autosaveResume(resumeData : Resumevalues) {
    ...
    const [lastSavedData , setLastSavedData] = useState(
        structuredClone(resumeData) //Creates a clone of the resume data in the lastsavedData
    )
    ...
    useEffect(() => {
        ...
        async function save() {
            ...
            try {
                ...
                setIsError(true) //whenever we have error, we set it to true to know that we have a error
                ...
                const {dismiss} = toast({
                    ...
                    description: (
                        <div className="space-y-3">
                            <p>Sorry, could not save the changes.</p>
                            <Button
                            variant="secondary"
                            onClick={() => {
                                dismiss();
