...
export default function PersonalInfoForm({resumeData , setResumeData} : EditorFormProps){
    ...
    //Submitting the changes in the foorm immediately so that it is rendered live on the resume preview
        ...
        <div className="max-w-xl mx-auto space-y-6">
            <div className="space-y-1.5 text-center">
                <h2 className="text-2xl font-semibold">Personal Information</h2>
                 <p className="text-sm text-muted-foreground">Let's start by adding your personal details.</p>
            </div>
